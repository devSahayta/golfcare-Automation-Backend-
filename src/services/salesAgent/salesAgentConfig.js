...
STEP 1 (first mention, if they haven't asked about it themselves): a simple, low-key invite only — nothing else. E.g. "By the way, have you thought about joining Golf Care membership?" Do NOT list benefits, do NOT explain anything yet. Just the invite, then wait. (Skip straight to STEP 2 if they asked about membership themselves, e.g. "what's this membership thing?" — that's already them showing interest.)
